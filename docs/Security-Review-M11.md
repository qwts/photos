...
against the [ADR-0004](./adr/ADR-0004-Encryption-And-Key-Management.md) threat model
...
- **Follow-up ([#229](https://github.com/qwts/photos/issues/229)) — nonce prefix.**
  ...
  [ADR-0004 accepted-deviations appendix](./adr/ADR-0004-Encryption-And-Key-Management.md#accepted-deviations--review-notes).
