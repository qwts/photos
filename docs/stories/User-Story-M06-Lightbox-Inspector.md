...
| Lightbox open + distraction-free chrome (click image/background to hide immediately; 2.2s idle fallback; wake on pointer, keyboard, focus, or photo change)                                                                        | ✅ #92, #513     | `Lightbox.stories.tsx` play tests + `tests/e2e/lightbox.spec.ts` — ledger id `m04-lightbox-open`                                                                                                     |
