...
[Spike — Multi-Platform Port](Spike-Multi-Platform-Port); tracked on
[#519](https://github.com/qwts/photos/issues/519).

Related decisions: [ADR-0004](ADR-0004-Encryption-And-Key-Management) (crypto and
custody), [ADR-0005](ADR-0005-Library-Data-Model) (layout),
[ADR-0008](ADR-0008-Recovery-Key-Format), [ADR-0013](ADR-0013-App-Lock-Key-Release-And-Protected-Albums),
[ADR-0017](ADR-0017-Multi-Library-Registry-Keying-And-Lifecycle).
...
metadata stripped, per [ADR-0006](ADR-0006-Media-Processing).
...
- **The backup/offload remote format is out of scope here** — see
  [ADR-0007](ADR-0007-Backup-Format-And-Offload),
  [ADR-0009](ADR-0009-Cloud-Recovery-Bootstrap-And-Manifest-V2), and
  [ADR-0012](ADR-0012-Continuous-Backup-Integrity-And-Recovery-Repair). Blobs
