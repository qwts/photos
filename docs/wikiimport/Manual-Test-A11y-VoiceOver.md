...
> ([Testing Strategy](Testing-Strategy)) prove the a11y *tree* is well-formed; they cannot
...
[July 2026 audit](Accessibility-Audit-2026-07) — the Lightbox not being a dialog, toasts
...
- Enter a wrong password 5× to trigger the throttle. **Known fail** (finding 26): the
  ...
  [accepted exception](Accessibility-Audit-2026-07#accepted-exceptions) (2.2.1 Essential).
...
- File each **new** finding as its own issue, severity-ranked, linked to
  ...
  [audit report](Accessibility-Audit-2026-07).
