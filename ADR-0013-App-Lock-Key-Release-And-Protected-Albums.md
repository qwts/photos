...
| Protected album create/protect/unlock/relock/change/remove/recover                          | #309             | KDF/key-slot/migration tests, stories, Electron E2E                     |
| Protected-domain query/count/protocol/export/sync/cache/deep-link leakage audit             | #309             | Table-driven repository/service/protocol bypass suite                   |
| Shared-photo conflict rule, crash-safe re-encryption, backup/restore isolation              | #309             | Migration kill matrix and disaster-recovery contract                    |
