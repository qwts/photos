...
- `m20-protected-albums` → [Protected Albums acceptance](Acceptance-Test-Protected-Albums), `tests/e2e/protected-albums.spec.ts`, protected ceremony/view Storybook interactions, and the custody/migration/leakage/cloud suites from PRs #330, #342, #353, #354, and #356. The deferred ledger entry is replaced by executable evidence.
